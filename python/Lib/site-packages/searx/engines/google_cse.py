...
paging = True
max_page = 5
# Smaller pages reduce CSE 429 rate-limit pressure; pagination still works.
page_size = 10
...
def request(query: str, params: "OnlineParams") -> None:
    ...
    # Do not pass lr/cr from upstream google traits: lr was too harsh for exact
    # Chinese company matches, and traits map zh-CN -> country HK which biases
    # Traditional Chinese / Hong Kong results. For this mainland deployment,
    # prefer Simplified Chinese + CN region on neutral ``all`` and zh-CN.
    ...
    if sxng_locale in ("all", "zh", "zh-CN") or sxng_locale.startswith("zh_Hans"):
        ...
        # zh-TW / zh-HK keep the traits-derived interface language and region.
