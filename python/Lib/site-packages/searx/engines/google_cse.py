...
def request(query: str, params: "OnlineParams") -> None:
    ...
    # Keep hl for UI language only. Passing lr/cr/gl into this public CSE
    # endpoint materially changes ranking versus google.com and often drops
    # exact-match Chinese company results when the UI locale is zh-CN.
    if token["exp"]:
        args["exp"] = token["exp"]
